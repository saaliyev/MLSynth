...
class DualPipeManualSplit(Orchestrator):
    def __init__(self, 
        model: Model,
        config):
        self.model = model
...
# heads: attention_compute | tails: ffwd_compute
    ...
    # heads: first node (attention) | tails: second node (ffwd)
        ...
        first_half_heads = forward_nodes_of_first_half[0][::2]   # mb 0, 1, 2... 9
        first_half_tails = forward_nodes_of_first_half[0][1::2]  # mb 0, 1, 2... 9

        second_half_heads = forward_nodes[0][::2]                # mb 10, 11, 12... 19
        second_half_tails = forward_nodes[0][1::2]               # mb 10, 11, 12... 1

        first_half_bwd_heads = backward_nodes_of_first_half[0][::2]   # mb 0, 1... 9
        first_half_bwd_tails = backward_nodes_of_first_half[0][1::2]  # mb 0, 1... 9

        second_half_bwd_heads = backward_nodes[0][::2]                # mb 10, 11... 19
        second_half_bwd_tails = backward_nodes[0][1::2]               # mb 10, 11... 19

        # add_dependencies(second_half_heads[0], [first_half_tails[6]])
        # add_dependencies(first_half_heads[7], [second_half_tails[3]])
        # add_dependencies(second_half_bwd_heads[3], [first_half_tails[7]])  
        # add_dependencies(first_half_bwd_heads[0], [second_half_tails[4]])
        # add_dependencies(second_half_bwd_heads[4], [first_half_tails[8]])
        # add_dependencies(first_half_bwd_heads[1], [second_half_tails[5]])
        # add_dependencies(second_half_bwd_heads[5], [first_half_tails[9]])
        # add_dependencies(first_half_bwd_heads[2], [second_half_tails[6]])
        # add_dependencies(second_half_bwd_heads[6], [first_half_bwd_tails[2]])
        


        first_half_heads = forward_nodes_of_first_half[2][::2]   # mb 0, 1, 2... 9
        first_half_tails = forward_nodes_of_first_half[2][1::2]  # mb 0, 1, 2... 9

        second_half_heads = forward_nodes[2][::2]                # mb 10, 11, 12... 19
        second_half_tails = forward_nodes[2][1::2]               # mb 10, 11, 12... 1

        first_half_bwd_heads = backward_nodes_of_first_half[2][::2]   # mb 0, 1... 9
        first_half_bwd_tails = backward_nodes_of_first_half[2][1::2]  # mb 0, 1... 9

        second_half_bwd_heads = backward_nodes[2][::2]                # mb 10, 11... 19
        second_half_bwd_tails = backward_nodes[2][1::2]               # mb 10, 11... 19


        add_dependencies(second_half_heads[0], [first_half_tails[2]])
        add_dependencies(first_half_heads[3], [second_half_tails[0]])
        add_dependencies(second_half_heads[1], [first_half_tails[3]])
        add_dependencies(first_half_heads[4], [second_half_tails[1]])
        add_dependencies(second_half_heads[2], [first_half_tails[4]])
        add_dependencies(first_half_heads[5], [second_half_tails[3]])
        add_dependencies(second_half_bwd_heads[1], [first_half_tails[5]])
        add_dependencies(first_half_bwd_heads[0], [second_half_tails[4]])
        add_dependencies(second_half_bwd_heads[2], [first_half_tails[6]])
        add_dependencies(first_half_bwd_heads[1], [second_half_tails[5]])
        ...
        add_dependencies(second_half_bwd_heads[5], [first_half_tails[9]])
        add_dependencies(first_half_bwd_heads[4], [second_half_tails[8]])
        add_dependencies(second_half_bwd_heads[6], [first_half_bwd_tails[4]]) 
        add_dependencies(first_half_bwd_heads[5], [second_half_tails[9]])
        add_dependencies(second_half_bwd_heads[7], [first_half_bwd_tails[5]])
        add_dependencies(first_half_bwd_heads[6], [second_half_bwd_tails[7]])
        add_dependencies(second_half_bwd_heads[8], [first_half_bwd_tails[6]])
        add_dependencies(first_half_bwd_heads[7], [second_half_bwd_tails[8]])



        second_half_heads = forward_nodes_of_first_half[5][::2]   # mb 10, 11, 12... 19
        second_half_tails = forward_nodes_of_first_half[5][1::2]  # mb 10, 11, 12... 19

        first_half_heads = forward_nodes[5][::2]                # mb 0, 1, 2... 9
        first_half_tails = forward_nodes[5][1::2]               # mb 0, 1, 2... 9

        second_half_bwd_heads = backward_nodes_of_first_half[5][::2]   # mb 10, 11... 19
        second_half_bwd_tails = backward_nodes_of_first_half[5][1::2]  # mb 10, 11... 19

        first_half_bwd_heads = backward_nodes[5][::2]                # mb 0, 1... 9
        first_half_bwd_tails = backward_nodes[5][1::2]               # mb 0, 1... 9
        ...
        first_half_heads = forward_nodes_of_first_half[1][::2]   # mb 0, 1, 2... 9
        first_half_tails = forward_nodes_of_first_half[1][1::2]  # mb 0, 1, 2... 9

        second_half_heads = forward_nodes[1][::2]                # mb 10, 11, 12... 19
        second_half_tails = forward_nodes[1][1::2]               # mb 10, 11, 12... 1

        first_half_bwd_heads = backward_nodes_of_first_half[1][::2]   # mb 0, 1... 9
        first_half_bwd_tails = backward_nodes_of_first_half[1][1::2]  # mb 0, 1... 9
        second_half_bwd_heads = backward_nodes[1][::2]                # mb 10, 11... 19
        second_half_bwd_tails = backward_nodes[1][1::2]               # mb 10, 11... 19

        add_dependencies(second_half_heads[0], [first_half_tails[4]])
        add_dependencies(first_half_heads[5], [second_half_tails[0]])
        add_dependencies(second_half_heads[1], [first_half_tails[5]])
        add_dependencies(first_half_heads[6], [second_half_tails[3]])
        add_dependencies(second_half_bwd_heads[2], [first_half_tails[6]])
        add_dependencies(first_half_bwd_heads[0], [second_half_tails[4]])
        add_dependencies(second_half_bwd_heads[3], [first_half_tails[7]])
        add_dependencies(first_half_bwd_heads[1], [second_half_tails[5]])
        ...
        add_dependencies(second_half_bwd_heads[5], [first_half_tails[9]])
        add_dependencies(first_half_bwd_heads[3], [second_half_tails[7]])
        add_dependencies(second_half_bwd_heads[6], [first_half_bwd_tails[3]])
        add_dependencies(first_half_bwd_heads[4], [second_half_tails[8]])
        add_dependencies(second_half_bwd_heads[7], [first_half_bwd_tails[4]])
        add_dependencies(first_half_bwd_heads[5], [second_half_tails[9]])
        add_dependencies(second_half_bwd_heads[8], [first_half_bwd_tails[5]])
        add_dependencies(first_half_bwd_heads[6], [second_half_bwd_tails[8]])
        add_dependencies(second_half_bwd_heads[9], [first_half_bwd_tails[6]])
        add_dependencies(first_half_bwd_heads[7], [second_half_bwd_tails[9]])




        tensor_size = int((12*d*d*b + 10*S*d*b) * self.scale)

        # calculate flops for the attention block
        attention_flops = int(11544872091648*0.85)
        print(F"Attention FLOPs: {attention_flops}")
        attention_compute = compute(attention_flops, tensor_size, name=f"Completely useless_attention_compute")
        

        
        # calculate flops for the mlp block
        ffwd_flops = int(21990232555520*0.85)
        ffwd_parent = [attention_compute]
        ffwd_compute = compute(ffwd_flops, tensor_size, parents=ffwd_parent, name=f"Completely useless_ffwd_compute")        
        print(F"FFWD FLOPs: {ffwd_flops}")
        # tensor parallel allreduce

        nodes1: list[ChakraNode] = [attention_compute]
        nodes1.append(ffwd_compute)
        nodes[5].append(nodes1[0])
        nodes[5].append(nodes1[1])

        

        first_half_heads = forward_nodes_of_first_half[5][::2]   # mb 0, 1, 2... 9
        first_half_tails = forward_nodes_of_first_half[5][1::2]  # mb 0, 1, 2... 9

        second_half_heads = forward_nodes[5][::2]                # mb 10, 11, 12... 19
        second_half_tails = forward_nodes[5][1::2]               # mb 10, 11, 12... 1

        first_half_bwd_heads = backward_nodes_of_first_half[5][::2]   # mb 0, 1... 9
        first_half_bwd_tails = backward_nodes_of_first_half[5][1::2]  # mb 0, 1... 9
        second_half_bwd_heads = backward_nodes[5][::2]                # mb 10, 11... 19
        second_half_bwd_tails = backward_nodes[5][1::2]               # mb 10, 11... 19

        add_dependencies(nodes1[0], [first_half_bwd_tails[1]])
        add_dependencies(first_half_heads[4], [nodes1[1]])
        ...
        add_dependencies(second_half_bwd_heads[6], [first_half_bwd_tails[2]])
        add_dependencies(first_half_bwd_heads[3], [second_half_tails[7]])
        add_dependencies(second_half_bwd_heads[7], [first_half_bwd_tails[3]])
        add_dependencies(first_half_bwd_heads[4], [second_half_tails[8]])
        add_dependencies(second_half_bwd_heads[8], [first_half_bwd_tails[4]])
        add_dependencies(first_half_bwd_heads[5], [second_half_tails[9]])
        add_dependencies(second_half_bwd_heads[9], [first_half_bwd_tails[5]])
        add_dependencies(first_half_bwd_heads[6], [second_half_bwd_tails[9]])





        second_half_heads = forward_nodes_of_first_half[6][::2]   # mb 10, 11, 12... 19
        second_half_tails = forward_nodes_of_first_half[6][1::2]  # mb 10, 11, 12... 19

        first_half_heads = forward_nodes[6][::2]                # mb 0, 1, 2... 9
        first_half_tails = forward_nodes[6][1::2]               # mb 0, 1, 2... 9

        second_half_bwd_heads = backward_nodes_of_first_half[6][::2]   # mb 10, 11... 19
        second_half_bwd_tails = backward_nodes_of_first_half[6][1::2]  # mb 10, 11... 19
        first_half_bwd_heads = backward_nodes[6][::2]                # mb 0, 1... 9
        first_half_bwd_tails = backward_nodes[6][1::2]               # mb 0, 1... 9
        ...
        second_half_heads = forward_nodes_of_first_half[7][::2]   # mb 10, 11, 12... 19
        second_half_tails = forward_nodes_of_first_half[7][1::2]  # mb 10, 11, 12... 19

        first_half_heads = forward_nodes[7][::2]                # mb 0, 1, 2... 9
        first_half_tails = forward_nodes[7][1::2]               # mb 0, 1, 2... 9

        second_half_bwd_heads = backward_nodes_of_first_half[7][::2]   # mb 10, 11... 19
        second_half_bwd_tails = backward_nodes_of_first_half[7][1::2]  # mb 10, 11... 19
        first_half_bwd_heads = backward_nodes[7][::2]                # mb 0, 1... 9
        first_half_bwd_tails = backward_nodes[7][1::2]               # mb 0, 1... 9
        ...
        nodes2: list[ChakraNode] = [attention_compute]
        nodes2.append(ffwd_compute)
        nodes[2].append(nodes2[0])
        nodes[2].append(nodes2[1])
        ...
        add_dependencies(nodes2[0], [second_half_bwd_tails[1]])
        add_dependencies(second_half_heads[4], [nodes2[1]])
